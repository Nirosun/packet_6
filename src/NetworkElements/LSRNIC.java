...
public class LSRNIC {
	...
	private int startDropAt = 50; // the minimum number of packets in the output buffer before we start dropping packets
	/**
	...
	/**
	 * Get next LSR connected to this NIC
	 * @return
	 */
	public LSR getNextLSR() {
		return this.link.getOtherNIC(this).getParent();
	}
